...
describe('resolveCudyrPendingStatus', () => {
  ...
  it('shows the normal application window during the night and following morning', () => {
    expect(
      resolveCudyrPendingStatus('2026-07-16', new Date('2026-07-17T07:00:00.000Z')).phase
    ).toBe('application_window'); // 01:00 Rapa Nui
    expect(
      resolveCudyrPendingStatus('2026-07-16', new Date('2026-07-17T17:00:00.000Z')).phase
    ).toBe('application_window'); // 11:00 Rapa Nui
  });
