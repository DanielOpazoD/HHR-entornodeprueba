...
import { resolveMovementDisplayDateLabel } from '@/features/census/controllers/censusMovementDatePresentationController';
    ...
    <div className="flex flex-col items-center">
      <div className="w-24 rounded-md border border-slate-300 bg-slate-50 px-2 py-1">
        ...
        <div className="text-[10px] text-slate-500 leading-tight">
          ({resolveMovementDisplayDateLabel(recordDate, movementDate, movementTime)})
        </div>
      </div>
    </div>
  );
