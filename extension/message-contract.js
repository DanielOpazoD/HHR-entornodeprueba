(function (root) {
  ...
  const types = Object.freeze({
    ...
    OPEN_ENCOUNTER_REQUEST: 'RAYEN_OPEN_ENCOUNTER_REQUEST', PATIENT_DOCUMENT_MANAGER_REQUEST: 'RAYEN_PATIENT_DOCUMENT_MANAGER_REQUEST',
    ...
    PATIENT_HEADER_REQUEST: 'RAYEN_PATIENT_HEADER_REQUEST', MANUAL_PATIENT_CODE_REQUEST: 'RAYEN_MANUAL_PATIENT_CODE_REQUEST',
    ...
    PATIENT_CLINICAL_BUNDLE_REQUEST: 'RAYEN_PATIENT_CLINICAL_BUNDLE_REQUEST',
    CLINICAL_PANEL_REQUEST: 'RAYEN_CLINICAL_PANEL_REQUEST', CLINICAL_ANTECEDENTS_REQUEST: 'RAYEN_CLINICAL_ANTECEDENTS_REQUEST',
    ...
    LAB_PDF_BUNDLE_DOWNLOAD_REQUEST: 'RAYEN_LAB_PDF_BUNDLE_DOWNLOAD_REQUEST', LAB_PDF_BUNDLE_PROGRESS: 'RAYEN_LAB_PDF_BUNDLE_PROGRESS',
    ...
    HOSPITALIZED_PRESCRIPTION_OPTIONS_REQUEST: 'RAYEN_HOSPITALIZED_PRESCRIPTION_OPTIONS_REQUEST',
  ...
  const fieldRules = Object.freeze({
    ...
    [types.PATIENT_HEADER_REQUEST]: { encId: 'id' }, [types.MANUAL_PATIENT_CODE_REQUEST]: { encId: 'id' },
    ...
    [types.PATIENT_CLINICAL_BUNDLE_REQUEST]: {
      encId: 'id',
      fecha: 'string',
      censusDate: 'string?',
      lookbackDays: 'number?',
    ...
    [types.LAB_PDF_BUNDLE_DOWNLOAD_REQUEST]: { batchId: 'string', examIds: 'array', requestId: 'string?' },
    ...
    [types.NURSING_MEDICAL_EPICRISIS_PRINT_REQUEST]: { encId: 'id?', patientRun: 'string', patientDocumentType: 'string?', admissionDate: 'string?', censusDate: 'string?', delivery: 'string?', operation: 'string?', documentType: 'string?' },
