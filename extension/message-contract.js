(function (root) {
  ...
  const types = Object.freeze({
    ...
    OPEN_ENCOUNTER_REQUEST: 'RAYEN_OPEN_ENCOUNTER_REQUEST', PATIENT_DOCUMENT_MANAGER_REQUEST: 'RAYEN_PATIENT_DOCUMENT_MANAGER_REQUEST', PATIENT_DOCUMENT_MANAGER_ACK: 'RAYEN_PATIENT_DOCUMENT_MANAGER_ACK',
  ...
  const fieldRules = Object.freeze({
    ...
    [types.PATIENT_DOCUMENT_MANAGER_REQUEST]: { encId: 'id', operation: 'string', routeHint: 'string?' },
    [types.PATIENT_DOCUMENT_MANAGER_ACK]: { requestId: 'string', opened: 'boolean', error: 'string?' },
