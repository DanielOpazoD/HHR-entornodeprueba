        ...
        return (
            <div className="flex flex-col items-center justify-center h-64 text-slate-400">
                ...
                <p className="text-sm mt-2">
                    Comienza a registrar datos en el censo diario.
                </p>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="text-sm text-slate-500 bg-slate-50 px-4 py-2 rounded-lg">
                Período: <span className="font-medium text-slate-700">{stats.periodStart}</span>
                {' → '}
                <span className="font-medium text-slate-700">{stats.periodEnd}</span>
                {' '}
                <span className="text-slate-400">
                    ({stats.totalDays} días con datos
                    {stats.calendarDays && stats.calendarDays !== stats.totalDays &&
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-emerald-50 rounded-lg p-4 text-center">
                            <div className="text-4xl font-bold text-emerald-600">
                                {stats.camasDisponibles}
                            </div>
                            <div className="text-sm text-emerald-800 mt-1">Camas Disponibles</div>
                        </div>
                        <div className="bg-orange-50 rounded-lg p-4 text-center">
                            <div className="text-4xl font-bold text-orange-600">
                                {stats.camasBloqueadas}
                            </div>
